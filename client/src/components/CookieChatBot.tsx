...
const FAQ_INTENTS: { key: string; keywords: string[]; answer: string; link?: { label: string; url: string } }[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "אין משלוחים", "רק איסוף", "אפשר לשלוח אליי", "איך מקבלים את ההזמנה",
    ],
    answer: "כרגע יש רק איסוף עצמי 📦 ברגע שהעוגיות מוכנות, תקבלו הודעה לאיסוף.",
  },
  {
    key: "location",
    keywords: ["איפה זה", "כתובת", "איפה לאסוף", "מיקום", "איפה נמצאים", "איפה האיסוף"],
    answer: "פרטי המיקום המדויק לאיסוף נשלחים אישית אחרי ההזמנה. לשאלות נוספות מוזמנים לפנות אלינו באינסטגרם 📍",
  },
  {
    key: "minimum",
    keywords: [
